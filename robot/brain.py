...
class Brain:
    def __init__(self, botp):
        ...
        # Softer mutual separation — previous values (15 frames @ -5.0) were
        # enough to fling bots ~75 px per encounter, which cascades into big
        # displacements near chargers where several bots cluster.
